...
<html>
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="images/myLogo.ico">
        ...
        <section>
            <table id="generalTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td width="50%">
                            <form id="myForm" method="POST" action="secondPage.php">
                                <table class="scallop" id="adjusting">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <label for="CoordinateXInput">Coordinate X:</label>
                                                <button id="CoordinateX" type="button" style="margin-left: 100px;">0</button>
                                                <input id="CoordinateXInput" type="hidden" name="xCoord" value="0">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <label for="CoordinateY">Coordinate Y:</label>  
                                                <input type="text" id="CoordinateY" name="CoordinateY" placeholder="Enter the number from -5 to 5" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <label for="Radius">Radius R:</label>
                                                <input type="text" id="Radius" name="Radius" placeholder="Enter the number from 1 to 4" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                        ...
                        <td width="50%">
                            <img class="scallop" id="graph" src="/Images/graph.png" alt="graph">
                        </td>
                    </tr>
                </tbody>
            </table>
