<template>
  <div id="footer">
      <table>
        <tbody>
        <tr>
          <td colspan="5" style="padding: 1vw 13vw 3vw 13vw;">
            Hello everyone!<br/> I am very glad that I finally made my first website!
            This site was made as part of laboratory work No. 4 in the ITMO University Web Programming course. I admit it wasn't easy, but it was worth it. See you on my next projects!<br/> Good luck!
          </td>
        </tr>
        <tr>
          <td width="25%">
