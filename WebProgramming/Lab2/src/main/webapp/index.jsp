...
<section>
    <table id="generalTable">
        <caption id="header">
            Stt1xX<br>Production
        </caption>
        <tbody>
        <tr>
            <td colspan="2">
                <div id="task" class="scallop">
                    <p>
                        Set the parameters for the graph and the coordinates of the point:
                    </p>
                </div>
            </td>
        </tr>
        <tr>
            <td width="50%">
                <form id="myForm" method="GET" action="./Controller">
                    <table class="scallop" id="adjusting">
                        ...
                        <tr>
                            <td>
                                <table id="CoordinateXtable">
                                    <caption>
                                        <label for="CoordinateXtable">Coordineate X:<br></label>
                                    </caption>
                                    <tbody>
                                    <tr>
                                        <td>
                                            <input type="radio" class="custom-radio" id="-5" name="xCoord" value="-5">
                                            <label for="-5" class="CoordX" name="CoordX">-5</label>
                                        </td>
                                        <td>
                                            <input type="radio" class="custom-radio" id="-4" name="xCoord" value="-4">
                                            <label for="-4" class="CoordX" name="CoordX">-4</label>
                                        </td>
                                        <td>
                                            <input type="radio" class="custom-radio" id="-3" name="xCoord" value="-3">
                                            <label for="-3" class="CoordX" name="CoordX">-3</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="radio" class="custom-radio" id="-2" name="xCoord" value="-2">
                                            <label for="-2" class="CoordX" name="CoordX">-2</label>
                                        </td>
                                        <td>
                                            <input type="radio" class="custom-radio" id="-1" name="xCoord" value="-1">
                                            <label for="-1" class="CoordX" name="CoordX">-1</label>
                                        </td>
                                        <td>
                                            <input type="radio" class="custom-radio" id="0" name="xCoord" value="0">
                                            <label for="0" class="CoordX" name="CoordX">0</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                        ...
                        <tr>
                            <td>
                                <label for="CoordinateY">Coordinate Y:<br></label>
                                <input type="text" id="CoordinateY" name="yCoord" maxlength="13" placeholder="Enter the number from -3 to 3">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label for="Radius">Radius R:<br></label>
                                <input type="text" id="Radius" name="Radius" maxlength="13" placeholder="Enter the number from 1 to 4">
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <td width="50%">
                <div id="canvasWrapper" class="scallop">
                    <canvas id="graph" width="560px" height="560px">Браузер не поддерживает canvas</canvas>
                </div>
            </td>
        </tr>
                ...
                <div id="tableWrap" class="scallop">
                    <table id="table">
                        ...
                        <%
                            ...
                            if (list != null){
                                ListIterator<Attempt> li = list.listIterator(list.size());

                                while(li.hasPrevious()){
                                    Attempt attempt = li.previous();
                                    out.println("<tr>" +
                                            "<td>" + attempt.getIsHit() +
                                            "</td>" +
                                            "<td>" + attempt.getX() +
    ...
    <table id="footer">
        ...
        <tr>
            <td colspan="4" style="padding: 1vw 13vw 3vw 13vw;">
                ...
                This site was made as part of laboratory work No. 1 in the ITMO University Web Programming course. I admit it wasn't easy, but it was worth it. See you on my next projects!<br> Good luck!
            </td>
        </tr>
        <tr>
            <td width="25%">
